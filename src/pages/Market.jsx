        ...
        <div className="machine-card" key={index}>
          ...
          <div className="machine-info">
            ...
            <div className="profit">
              <span className="value">${machine.profit}</span>
              <p>Profit / Hour</p>
            </div>

            <div className="price">
              <span className="value">${machine.price}</span>
              <p>Price</p>
            </div>
        ...
        <div className="modal-overlay">
          ...
          <div className="details-modal">
            ...
            <div className="details-grid">
              ...
              <div>
                <span>${selectedMachine.price}</span>
                <p>Machine Price</p>
              </div>

              <div>
                <span>${selectedMachine.profit}</span>
                <p>Profit / Hour</p>
              </div>

              <div>
                <span>${(selectedMachine.profit * 24).toFixed(2)}</span>
                <p>Daily Profit</p>
              </div>
