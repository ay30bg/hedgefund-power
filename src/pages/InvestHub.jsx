...
import { useBalance } from "../context/BalanceContext"; // ✅ ADD THIS
...
export default function InvestHub() {
  ...
  const { balance, setBalance } = useBalance(); // ✅ ADD BALANCE
        ...
        <div className="invest-overlay">
          ...
          <div className="invest-modal">
            ...
            <div className="modal-actions">
              ...
              <button className="modal-confirm" onClick={handleInvest}>
                Confirm Investment
              </button>
